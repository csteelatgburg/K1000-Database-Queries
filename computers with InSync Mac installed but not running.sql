...
(select PROCESS.NAME FROM PROCESS JOIN MACHINE_PROCESS_JT on MACHINE_PROCESS_JT.PROCESS_ID = PROCESS.ID WHERE PROCESS.NAME = "inSync" and MACHINE_PROCESS_JT.MACHINE_ID = M.ID) as inSyncProcess
